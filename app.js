...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    instruction.innerHTML = "Get three or more items in a row and level up once you pass the 'Score To Beat.' Some levels come with new vending machine goodies! Move vending machine items left, right, up, down or diagonally one step. Start playing now!"
